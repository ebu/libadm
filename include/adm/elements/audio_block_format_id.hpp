...
namespace adm {
  ...
  class AudioBlockFormatId {
   public:
    ...
    /// @brief Set value
    LIBADM_EXPORT void set(AudioBlockFormatIdValue value);
    /// @brief Set counter
    LIBADM_EXPORT void set(AudioBlockFormatIdCounter counter);
     ...
     */
    LIBADM_EXPORT bool operator==(const AudioBlockFormatId& other) const;
    LIBADM_EXPORT bool operator!=(const AudioBlockFormatId& other) const;
    LIBADM_EXPORT bool operator<(const AudioBlockFormatId& other) const;
    ///@}
   ...
   private:
    ...
    LIBADM_EXPORT AudioBlockFormatIdValue
        get(detail::ParameterTraits<AudioBlockFormatIdValue>::tag) const;
    LIBADM_EXPORT AudioBlockFormatIdCounter
  ...
  parseAudioBlockFormatId(const std::string& id);
  /// @brief Format an AudioBlockFormatId object as string
  LIBADM_EXPORT std::string formatId(AudioBlockFormatId id);
