...
namespace adm {
  ...
  class AudioProgrammeId {
   public:
    ...
    /// @brief Set value
    LIBADM_EXPORT void set(AudioProgrammeIdValue value);
     ...
     */
    LIBADM_EXPORT bool operator==(const AudioProgrammeId& other) const;
    LIBADM_EXPORT bool operator!=(const AudioProgrammeId& other) const;
    LIBADM_EXPORT bool operator<(const AudioProgrammeId& other) const;
    ///@}
   ...
   private:
    LIBADM_EXPORT AudioProgrammeIdValue
  ...
  LIBADM_EXPORT AudioProgrammeId parseAudioProgrammeId(const std::string& id);
  /// @brief Format an AudioProgrammeId object as string
  LIBADM_EXPORT std::string formatId(AudioProgrammeId id);
