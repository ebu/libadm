...
namespace adm {
  namespace xml {
    ...
    BaseXmlParser::BaseXmlParser(rapidxml::file<> file, ParserOptions options)
    ...
    std::shared_ptr<AudioProgramme> BaseXmlParser::parseAudioProgramme(
        NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioContent> BaseXmlParser::parseAudioContent(NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioObject> BaseXmlParser::parseAudioObject(NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioPackFormat> BaseXmlParser::parseAudioPackFormat(
        NodePtr node) {
      // clang-format off
    ...
    void BaseXmlParser::setCommonProperties(
    ...
    std::shared_ptr<AudioChannelFormat> BaseXmlParser::parseAudioChannelFormat(
        NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioStreamFormat> BaseXmlParser::parseAudioStreamFormat(
        NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioTrackFormat> BaseXmlParser::parseAudioTrackFormat(
        NodePtr node) {
      // clang-format off
    ...
    std::shared_ptr<AudioTrackUid> BaseXmlParser::parseAudioTrackUid(NodePtr node) {
      // clang-format off
